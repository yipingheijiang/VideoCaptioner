...
class SettingInterface(ScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        self.checkButton = PushSettingCard(
            self.tr("检查连接"),
            FIF.LINK,
            self.tr("检查 LLM 连接"),
    ...
    def __initLayout(self):
        ...
        self.llmGroup.addSettingCard(self.checkButton)
    ...
    def __connectSignalToSlot(self):
        ...
        # 检查 LLM 连接
        self.checkButton.clicked.connect(self.checkLLMConnection)
